...
if not cap.isOpened():
    print(f"FATAL ERROR: Could not open camera with index {CAMERA_INDEX}. Check hardware and permissions.")
    sys.exit(1)

print("--- Real-Time OCR Started (Event-Based Logging) ---")
print("Focus text on the camera. Press 'q' to exit. Log will auto-save only frames where text was detected.")
...
try:
    ...
    while True:
        ...
        # Using a fixed threshold for simplicity. You can adjust 150 as needed.
        ...
        # Only log the data if at least one word was detected after cleaning
        if non_duplicate_count > 0:
            ...
            frame_record = {
                ...
                "keywords": keywords,
                "detected_words_list": word_list # Words after consecutive duplicate removal
            }
